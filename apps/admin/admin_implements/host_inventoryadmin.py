...
from models.db_models.host_inventory import Host_inventory
from core import i18n as _

class Host_inventoryAdmin(admin.ModelAdmin):
    group_schema = None
    page_schema = PageSchema(label=_('host_inventory'), page_title=_('host_inventory'), icon='fas fa-server')
    model = Host_inventory
    pk_name = 'id'
